...
export default function BlogHome() {
  const blogsCards = [
    
    {
      ...
      title: "Adhunik FireXpert Company: Your Trusted Partner for Comprehensive Fire Safety Solutions in Delhi NCR and India",
      para: "May 2025 by Adhunik FireXpert Company",
