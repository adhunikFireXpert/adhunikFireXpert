...
export default function FireSprinklerS() {
    ...
    const sprinklerwhychoose = [
...

        {
            ...
            description: "Adhunik FireXpert prioritizes the safety of lives and property in Delhi NCR, providing fire sprinkler systems that offer superior protection.",
        },
                ...
                <div className="container mx-auto px-4">
                    <div className="flex justify-around flex-col lg:flex-row items-center gap-12">
                        ...
                        <div className="lg:w-6/12 w-full">
                            <h1 className="text-3xl font-bold mb-4 text-center md:text-left" >Adhunik FireXpert : Your Trusted Fire Sprinkler System Supplier, Distributor, and Installer in Delhi NCR
                            </h1>
                            ...
                            <p className="text-gray-700  text-justify md:text-left">
                                At Adhunik FireXpert, we understand the unique fire safety challenges faced by businesses and residents in the Delhi NCR region. Fire sprinkler systems are a vital element of any robust fire protection strategy, providing dependable and effective fire suppression to safeguard lives and minimize property damage. As a leading supplier, distributor, and installer of fire sprinkler systems throughout Delhi NCR, Adhunik FireXpert is dedicated to delivering superior quality systems and expert services tailored to your specific requirements and local regulations.
                    ...
                    <div className="row py-5">
                        ...
                        <h2 className="text-2xl pt-4 font-bold mb-4 text-center md:text-left">
                            Types of Fire Sprinkler Systems Offered by Adhunik FireXpert in Delhi NCR
                    ...
                    <div className="row">
                        <h2 className="text-2xl pt-3 py-2 font-bold mb-4 text-center md:text-left">
                            Why Choose Adhunik FireXpert as Your Fire Sprinkler System Partner in Delhi NCR ?
                        </h2>
