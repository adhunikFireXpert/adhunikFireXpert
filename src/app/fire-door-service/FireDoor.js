            ...
            <div className="flex justify-around flex-col lg:flex-row items-center ">
              ...
              <div className="lg:w-6/12 w-full mt-8 lg:mt-0">
                ...
                <h1 className=" md:text-2xl  text-center md:text-left font-bold mb-4">
                  Adhunik FireXpert : Fire Doors in Delhi NCR - Manufacturer, Supplier &
                  Installation
                </h1>

                <h2 className="  font-semibold py-4 text-center md:text-left">
                  Protecting Lives and Property with High-Quality Fire Doors in
                  Delhi NCR
                </h2>

                <p className=" text-sm text-gray-700 text-justify md:text-left">
                  Ensuring robust fire safety measures is paramount in the
                  bustling and densely populated Delhi NCR region. At Zedex
                  Fire, an ISO 9001:2008 certified company, we understand the
                  critical role that high-quality fire doors play in slowing the
                  spread of fire and smoke, providing precious time for safe
                  evacuation, and minimizing property damage. Our comprehensive
                  range of fire doors and fire safety doors is meticulously
                  designed and manufactured to meet stringent national and
                  international safety standards, offering unparalleled
                  protection for commercial, industrial, and residential
                  properties across Delhi, Noida, Gurgaon, Faridabad, and
                  Ghaziabad.
                </p>
