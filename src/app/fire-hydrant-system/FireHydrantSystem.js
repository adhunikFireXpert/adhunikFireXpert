...
export default function FireHydrantSystem() {
   ...
   const FireHydrantsystem = [
    ...
    const FireHydranttypes = [

        {
            title: "Wet Barrel Fire Hydrants – ",
            description: " Ideal for areas in India, including parts of the NCR, where freezing temperatures are not a primary concern, offering immediate water access.",
        },
...

        {
            ...
            description: "  Perfect for specific applications in colder regions of India or where preventing freezing is crucial. ",
        },
...

        {
            ...
            description: "Essential for multi-story buildings in Delhi NCR and across India, providing water access on every floor. ",
        },
        ...
        {
            title: "Underground and Above Ground Hydrant Systems – ",
            description: " Customized solutions based on site requirements and aesthetics throughout Delhi NCR and India's varied landscapes.",
        },

        {
            title: "Automatic Fire Hydrant Systems - ",
            description: " Advanced systems for rapid fire detection and suppression, suitable for various properties in Delhi NCR and India.",
        },
...

        {
            ...
            description: " We supply all necessary components nationwide, including : ",
        },
    ...
    const FireHydranttypes2 = [
        ...
        {
            title: "Control Valves (Gate Valves, Non-Return Valves, etc.) ",
        ...
        {
            title: "Hose Reels and Cabinets ",

        },

        {
            title: "Fire Department Connections (FDCs) ",

        },
        {
            title: "Nozzles and Accessories ",
    ...
    const FireHydranttypes3 = [

        {
            title: "Detailed Site Assessment – ",
            description: "  Our experts conduct a thorough evaluation of your property, regardless of its location in Delhi NCR or India, to understand your specific fire safety needs and identify optimal hydrant locations.",
        },

        {
            title: "Customized System Design – ",
            description: "We develop a tailored fire hydrant system design that complies with local fire safety regulations applicable to your region in Delhi NCR or India and your property's layout.",
        },

        {
            title: "High Quality Material Procurement – ",
            description: " We source and use only the best quality materials and components suitable for the specific climate and conditions of your location in India.",
        },


        {
            title: "Expert Installation – ",
            description: " Our certified technicians handle the entire installation process, ensuring precision and adherence to relevant safety standards across Delhi NCR and India.",
        },

        {
            title: "Rigorous Testing and Commissioning – ",
            description: "  We conduct thorough testing to ensure the system functions flawlessly and meets all required pressure and flow rates according to national and local standards.",
        },

        {
            title: "Training and Handover – ",
            description: "  We provide comprehensive training to your staff on the operation and basic maintenance of the fire hydrant system, tailored to your location in Delhi NCR or India.",
        },


        {
            title: "Ongoing Maintenance and Support – ",
            description: " Adhunik FireXpert offers reliable maintenance and support services nationwide to keep your Fire Hydrant System in optimal working condition.",
        },
