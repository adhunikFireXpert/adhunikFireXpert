...
export default function AntiRodentSystem() {
    ...
    const KeyFeatures = [
        ...
        {
            title: "Backed by Adhunik FireXpert's Expertise",
                    ...
                    <div className="container mx-auto px-4">
                        ...
                        <div className="flex flex-col lg:flex-row items-center">
                            ...
                            <div className="lg:w-6/12 w-full mt-8 lg:mt-0">
                                ...
                                <h1 className="md:text-2xl font-bold mb-4 text-center md:text-left ">Adhunik FireXpert Anti-Rodent System in Delhi NCR
                                </h1>
                        ...
                        <div className="mt-20">
                            ...
                            <p className="text-gray-700 md:mb-6 py-5  text-center md:text-left">
                                The <strong>Adhunik FireXpert Anti-Rodent System</strong> offers a proactive approach to prevent these issues before they escalate.
                            </p>
                        </div>
                        ...
                        <div className=" mt-10 md:mt-20">
                            <h2 className="md:text-2xl text-center md:text-left font-bold mb-6">
                                Introducing the Intelligent Adhunik FireXpert Anti-Rodent System : Your Shield Against Rodents in Delhi NCR
                            ...
                            <p className="text-gray-700 mb-6 text-center md:text-left md:text-2xl font-semibold">
                                Key Features and Benefits of the Adhunik FireXpert Anti-Rodent System :
                        ...
                        <div className=" mt-10 md:mt-20">
                            <h2 className=" text-center md:text-left md:text-2xl font-bold mb-6">
                                Why Choose Adhunik FireXpert for Your Anti-Rodent System Needs in Delhi NCR?

                            </h2>
                            <p className="text-gray-700 text-justify mb-4 py-2">
                                When it comes to protecting your property from the detrimental effects of rodents, you need a partner you can trust. Adhunik FireXpert offers
                                ...
                                <div className="w-full flex flex-col justify-start lg:items-start items-center gap-3">
                                    ...
                                    <div className=" relative inline-flex py-2 items-center justify-center w-full mx-auto mt-10  my-4 md:mb-0">
                                        ...
                                        <h2 className="absolute px-2 md:px-3 text-gray-700 -translate-x-1/2 bg-white left-1/2 text-center text-[14px] md:text-2xl capitalize font-semibold font-sans">
                                            Protect Your Property Today with the Adhunik FireXpert Anti-Rodent System in Delhi NCR
                                    ...
                                    <p className="font-sans md:text-center  w-full py-4 text-justify "  >
                                        Don't wait until rodents cause costly damage or compromise your safety. Invest in the proactive protection offered by the Adhunik FireXpert Anti-Rodent System.
                                        Ensure the safety and longevity of your infrastructure with the reliable Adhunik FireXpert Anti-Rodent System – your trusted partner in Delhi NCR.
                                    </p>
