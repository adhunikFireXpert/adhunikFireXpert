...
export default function OurCompany() {
  ...
  <div className="relative w-full pt-32 py-24  flex flex-col items-center justify-center text-center text-white p-8 overflow-hidden">
          {/* Video Background */}
          ...
          <div className="relative z-20 flex flex-col items-center justify-center">
           <div className="container mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-16 items-start">

        {/* Left Column: Text Content */}
        <div className="flex flex-col space-y-6">

          <div className="uppercase text-left pl-2  text-sm tracking-widest text-gray-600">
        ...
        <div className="card h-[90vh] w-full">
 <img
