...
export const metadata = {
    ...
    images: [
      {
        ...
        url: "https://res.cloudinary.com/djablkulv/image/upload/v1764306866/support-help_nzgge4.webp",
        width: 1200,
        height: 630,
 ...
 robots: "index, follow",
  twitter: {
    ...
    title: "Adhunik FireXpert - Comprehensive Fire Safety Solutions",
    description: "Your trusted partner for fire safety and protection systems across Delhi, Gurugram, and Noida. We provide certified installation and maintenance services.",
    image: "https://res.cloudinary.com/djablkulv/image/upload/v1764306866/support-help_nzgge4.webp", // Use the same OpenGraph image for consistency
  },
}
