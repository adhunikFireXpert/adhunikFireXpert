    ...
    <>
        ...
        <div className="relative flex  h-[86vh] md:h-[67vh] w-full">
          ...
          <div className="absolute w-full h-full p-9 bottom-0 flex flex-col md:flex-row justify-center md:justify-between items-center md:text-center mx-auto">
            <p className="text-center md:text-left text-red-50 text-6xl font-bold flex flex-col justify-center items-center h-full my-auto">
              OUR CLIENTS
              <br />
              <span className="text-center  text-[15px] pt-5 w-full md:text-start uppercase">
                Home / OUR CLIENTS
              </span>
            </p>
          </div>
      ...
      <section>
        <div className="container-fluid">
          <h1 className=" md:text-2xl  text-center  pt-5 font-bold text-red-900">
            Trusted by Industry Leaders for Fire Safety Excellence
          </h1>

          <div className="card flex justify-center items-center">
            <p className=" text-center text-sm w-full px-2 md:w-6/12 py-5 font-bold text-red-900">
              Adhunik FireXpert Fire Service proudly partners with restaurants,
              hospitals, industrial facilities, and commercial enterprises
              across India. Our certified fire safety solutions have helped
              clients prevent <br /> disasters and comply with regulations –
              delivering peace of mind through every installation, inspection,
