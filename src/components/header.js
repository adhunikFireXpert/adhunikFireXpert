...
function Header() {
  ...
  const links = [
...

    {
      ...
      text: ' Service ',
      dropdownItems: [
        { label: 'Fire Extinguisher ISI Mark ', href: '/fire-extinguishers' },
    ...
    { text: 'Contact Us', href: '/help-and-support' },
  ];
  ...
  const [logoSrc, setLogoSrc] = useState('https://res.cloudinary.com/ddkyx2jhh/image/upload/v1755763611/next2_d1l72h.webp');
  const [logoSize, setLogoSize] = useState({ width: '180', height: '44' });
  ...
  useEffect(() => {
    if (pathname) {
      if (pathname === '/fire&safety' || pathname === '/fire-extinguishers' || pathname === '/fire-hydrant-system' || pathname === '/fire-sprinkler-system' || pathname === '/fire-suppression-system' || pathname === '/glow-signage-&-emergency-lights' || pathname === '/fire-tubing-system' || pathname === '/fire-vesda-system' || pathname === '/addressable-fire-alarm-system-in-delhi-ncr') {
        setLogoSrc('https://res.cloudinary.com/ddkyx2jhh/image/upload/v1755763611/next2_d1l72h.webp');
  ...
  return (
    ...
    <nav className={`fixed h-[6.1rem] md:h-[7.5rem]  z-50 w-full top-0 transition-all duration-300 ${isScrolled ? " bg-gray-100 text-black shadow-md" : "bg-gradient-to-b from-black  text-white"
      }`}
    >
 ...
 <hr className='rotate-90 w-10  relative hidden lg:block' />
                  ...
                  <div className="col pb-2 md:pb-0  ps-5  md:ps-0">
                    ...
                    <svg onClick={() => window.location.href = "mailto:info@adhunikxpert.com"} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
                  ...
                  <div
                    ...
                    onClick={() => window.location.href = "mailto:info@adhunikxpert.com"}
                    style={{ cursor: 'pointer' }}
                  >
                    <p className="font-sans font-thin">Drop Us An Email</p>
                    <p>info@adhunikxpert.com</p>
                  </div>
...
<svg onClick={() => window.location.href = "tel:981xxxxxxx"} xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-6">
  <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 6.75c0 8.284 6.716 15 15 15h2.25a2.25 2.25 0 0 0 2.25-2.25v-1.372c0-.516-.351-.966-.852-1.091l-4.423-1.106c-.44-.11-.902.055-1.173.417l-.97 1.293c-.282.376-.769.542-1.21.38a12.035 12.035 0 0 1-7.143-7.143c-.162-.441.004-.928.38-1.21l1.293-.97c.363-.271.527-.734.417-1.173L6.963 3.102a1.125 1.125 0 0 0-1.091-.852H4.5A2.25 2.25 0 0 0 2.25 4.5v2.25Z" />
                  ...
                  <div
                    ...
                    onClick={() => window.location.href = "tel:981xxxxxxx"}
                    style={{ cursor: 'pointer' }}
                  >
              ...
              <div className="hidden xl:flex items-center space-x-1">
                ...
                <ul className="flex   flex-col font-medium p-4 md:p-0 mt-4 border rounded-lg md:space-x-6 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 ">
                  {menuItems.map((item, index) => (
                    <li className=" md:px-3 after:content-[''] after:block after:w-full after:h-[3px] after:bg-gradient-to-r after:from-red-500 after:to-red-700 after:scale-x-0  after:origin-left after:transition-transform after:duration-250 after:ease-in-out hover:after:scale-x-100 " key={index}>
                      {item.dropdown ? (
